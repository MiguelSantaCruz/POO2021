...
public class Lateral extends Jogador
{
     ...
     */
    public Lateral(int velocidade, int resistencia, int destreza, int impulsao, int jogo_de_cabeça, int remate, int capacidade_de_passe,int cruzamentos,String idAtleta,String nomeAtleta,int idade){
