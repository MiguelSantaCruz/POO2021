...
public class Guarda_Redes extends Jogador
{
     ...
     */
    public Guarda_Redes(int velocidade, int resistencia, int destreza, int impulsao, int jogo_de_cabeça, int remate, int capacidade_de_passe,int elasticidade,String idAtleta,String nomeAtleta,int idade){
