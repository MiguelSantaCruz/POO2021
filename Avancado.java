...
public class Avancado extends Jogador {
     ...
     * @param sprint
     */
    public Avancado (int velocidade, int resistencia,int destreza, int impulsao, int jogo_de_cabeça, int remate, int capacidade_de_passe, int finalizacao, int sprint) {
